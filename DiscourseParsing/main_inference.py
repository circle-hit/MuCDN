...
from utils import load_data, build_vocab, preview_data, get_batches, load_inference_data
...
# with open('./erc_data/meld/train.json') as f:
#     data_test = json.load(f)
data_test = load_inference_data('./erc_data/iemocap/test.json')

vocab, embed = build_vocab(data_train)
model_dir, log_dir = './' + FLAGS.prefix + '_model', 'DialogueDiscourseParsing/' + FLAGS.prefix + '_log'
...
with sess.as_default():
    ...
    out_file = '../erc-training/erc_data/iemocap/test_parsed.json'
