...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        r1, r2, r3, r4, \
        umask, label, dis_speaker_mask, dis_adj, \
        inter_adj, intra_adj, intra_relative_distance, inter_relative_distance, \
        = [data[i].cuda() for i in range(len(data))] if cuda else data
...
if __name__ == '__main__':
    # python train_meld_cp.py --hidden_dim 300 --pos --norm
    ...
    train_loader, valid_loader, test_loader = get_MELD_loaders(batch_size=batch_size, num_workers=0)
    ...
    for e in range(n_epochs):
        ...
        if test_fscore[0] > max_test_f1:
            ...
            increase_flag = True
            if args.save:
                torch.save(model.state_dict(), open('./meld/best_model.pkl', 'wb'))
